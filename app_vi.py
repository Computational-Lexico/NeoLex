...
#df = pd.read_json("/Users/lianchen/Desktop/CNRS/Stage-CNRS-ANR/STage5月-9月/实习报告/可视化/neo_vi.json")
df = pd.read_json("neo_vi.json")

st.set_page_config(page_title="Dictionnaire des néologismes", layout="wide")

st.title("Petit dictionnaire des néologismes du vietnamien moderne (2015-2025)")
